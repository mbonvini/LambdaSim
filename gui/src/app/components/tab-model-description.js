...
import { updateFilterString, updateFilterParameters, updateFilterConstants, updateFilterInputs, updateFilterOutputs, updateFilterContinuous } from '../actions/model-actions';
...
class TabModelDescription extends React.Component {
    ...
    filterVariable = (variable) => {
        ...
        return preCondition && nameCondition;
    }
        ...
        return (
            this.props.modelDescription ? (
                <div>
                    ...
                    <h4 style={styles.headline}>Variables</h4>
                    <TextField
                        hintText="model.x"
                        floatingLabelText="Filter rows by name"
                        fullWidth={true}
